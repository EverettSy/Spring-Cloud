 ...
 * @author syrobin
 * @version v1.0
 * @description: Kryo Utils
 * @date 2022-03-02 5:26 PM
 * @resources https://www.cnblogs.com/hntyzgn/p/7122709.html
 */
public class KryoUtil {
    ...
    public static <T> String writeObjectToString(T obj) {
        return new String(Base64.encodeBase64(writeObjectToByteArray(obj)), StandardCharsets.UTF_8);
    }
    ...
    public static <T> T readObjectFromString(String str, Class<T> clazz) {
        return readObjectFromByteArray(Base64.decodeBase64(str.getBytes(StandardCharsets.UTF_8)), clazz);
    }
