 ...
 */
@Service
public class HouseCodeServiceImpl implements NumberingStrategy {
    ...
    public String getCode(String cityCode) {
        if ("0571".equals(cityCode)){
            //杭州序号
            return CityCodeConstants.HZ_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("0512".equals(cityCode)){
            //苏州序号
            return CityCodeConstants.SZ_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("027".equals(cityCode)){
            //武汉序号
            return CityCodeConstants.WH_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("021".equals(cityCode)){
            //上海序号
            return CityCodeConstants.SH_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("028".equals(cityCode)){
            //成都序号
            return CityCodeConstants.CD_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("022".equals(cityCode)){
            //成都序号
            return  CityCodeConstants.TJ_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("0755".equals(cityCode)){
            //深圳序号
            return CityCodeConstants.SZS_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("0731".equals(cityCode)){
            //长沙序号
            return CityCodeConstants.CS_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("010".equals(cityCode)){
            //北京序号
            return  CityCodeConstants.BJ_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("020".equals(cityCode)){
            //广州序号
            return  CityCodeConstants.GZ_CITY_CODE_PREFIX + generateGiftCode();
        }else if ("023".equals(cityCode)){
            //重庆序号
            return CityCodeConstants.CQ_CITY_CODE_PREFIX + generateGiftCode();
